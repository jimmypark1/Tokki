 ...
 * Use the {@link MarketTagFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class MarketTagFragment extends Fragment {
    ...
    private MarketTagAdapter marketTagAdapter;
     ...
     * @return A new instance of fragment MarketTagFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static MarketTagFragment newInstance(String param1, String param2) {
        MarketTagFragment fragment = new MarketTagFragment();
                    ...
                    public void run() {
                        ...
                        getActivity().runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                marketTagAdapter = new MarketTagAdapter(getActivity(),markets);
                                recyclerView.setAdapter(marketTagAdapter);
...
//        CommonUtils.showProgressDialog(getActivity(), "서버에서 데이터를 가져오고 있습니다. 잠시만 기다려주세요.");
        ...
        if(sortHttp != null)
        {
            for (Call call : sortHttp.dispatcher().queuedCalls()) {
                if (call.request().tag().equals("SORT_TAG"))
                    call.cancel();
            }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                markets = HttpClient.getWorksSorByTagOnMarket(sortHttp,genre);
    ...
    public class MarketTagAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>  {
        Context context;
        ArrayList<MarketVO> arrayList;


        public MarketTagAdapter(Context context,ArrayList<MarketVO> arrayList) {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            ...
            return new MarketTagViewHolder(v);
        }
        ...
        {
            MarketTagViewHolder viewHolder = (MarketTagViewHolder) holder;
 ...
 */
    ...
    public class MarketTagViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public MarketTagViewHolder(@NonNull View itemView) {
