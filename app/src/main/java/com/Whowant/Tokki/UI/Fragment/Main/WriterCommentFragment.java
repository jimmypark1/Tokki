...
public class WriterCommentFragment extends Fragment {
    ...
    public WriterCommentFragment(String strUserID) {
    ...
    private void getCommentData() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                commentList = new ArrayList<>();
                pref = getActivity().getSharedPreferences("USER_INFO", Activity.MODE_PRIVATE);
                JSONArray resultArray = HttpClient.getChatCommentByID(new OkHttpClient(), strUserID);
...
//            ImageView subIconView = convertView.findViewById(R.id.subIconView);
...
//            }
    ...
    private void deleteComment(int nCommentID) {
        CommonUtils.showProgressDialog(getActivity(), "댓글을 삭제하고 있습니다.");
