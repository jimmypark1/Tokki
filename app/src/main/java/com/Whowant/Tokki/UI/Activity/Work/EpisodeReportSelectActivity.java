...
public class EpisodeReportSelectActivity extends AppCompatActivity {                                       // 신고 화면
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_episode_report_select);
    ...
    public void requestReport() {
        ...
        CommonUtils.showProgressDialog(EpisodeReportSelectActivity.this, "신고 내용을 전송 중입니다.");

        new Thread(new Runnable() {
            @Override
            public void run() {
                //OkHttpClient httpClient, String strUserID, String strAdminID, String strReason
                final int nResult = HttpClient.requestEpisodeReport(new OkHttpClient(), pref.getString("USER_ID", "Guest"), nEpisodeID, strSendReason);
//                boolean bResult = HttpClient.requestCommentReport(new OkHttpClient(), pref.getString("USER_ID", "Guest"), nEpisodeID, strReason);
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(nResult == 0) {
                            Toast.makeText(EpisodeReportSelectActivity.this, "신고 되었습니다.", Toast.LENGTH_SHORT).show();
                            finish();
                        } else if(nResult == 1) {
                            Toast.makeText(EpisodeReportSelectActivity.this, "이미 신고한 회차입니다.", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(EpisodeReportSelectActivity.this, "신고에 실패하였습니다. 잠시 후 다시 시도해 주세요.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
